...
public class ClientMgmtControllerParameterizedTest {
    ...
    private final static Object[][] TEST_CASES = new Object[][] {
            ...
            {"Unsupported grant type", new ClientDetailCreateRequestV2("client-id-v1", "client-name", jwk,
                    "rp-id", Arrays.asList("given_name"),
                    Arrays.asList("mosip:idp:acr:static-code"), "https://logo-url/png",
                    Arrays.asList("https://logo-url/png"), Arrays.asList("plain_grant"),
                    Arrays.asList("private_key_jwt"),new HashMap<String,String>(){{put("eng", "clientname");}}), null, null, ErrorConstants.UNSUPPORTED_GRANT_TYPE},
