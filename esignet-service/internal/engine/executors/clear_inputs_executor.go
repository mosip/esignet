...
// ExecutorNameEsignetClearInputs clears this node's configured inputs from the engine
// context so a subsequent PROMPT node re-asks the user for them.
const ExecutorNameEsignetClearInputs = "eSignetClearInputsExecutor"
...
func (e *clearInputsExecutor) GetName() string {
	return ExecutorNameEsignetClearInputs
}
