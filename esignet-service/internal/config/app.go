...
func applyDefaults(cfg *AppConfig) {
	...
	cfg.Provider = envOrDefault("MOSIP_ESIGNET_AUTHN_PROVIDER", "mock")
	cfg.LayoutID = envOrDefault("MOSIP_ESIGNET_LAYOUT_ID", "layout-esignet")
	cfg.ThemeID = envOrDefault("MOSIP_ESIGNET_THEME_ID", "theme-esignet")
	cfg.AuthFlowID = envOrDefault("MOSIP_ESIGNET_AUTH_FLOW_ID", "flow-esignet")
	...
	cfg.JWT.PreferredKeyID = envOrDefault("MOSIP_ESIGNET_SIGNING_KEY_REF_ID", "RSA_2048")
