...
type fakeQuerier struct {
	...
	getKeyAliasByCertThumbprintFn func(ctx context.Context, thumbprintHex string) (db.KeyAlias, error)
	getKeyAliasByUniIdentFn       func(ctx context.Context, uniIdent string) (db.KeyAlias, error)
...
func (f *fakeQuerier) GetKeyAliasByCertThumbprint(ctx context.Context, thumbprintHex string) (db.KeyAlias, error) {
	if f.getKeyAliasByCertThumbprintFn == nil {
		return db.KeyAlias{}, sql.ErrNoRows
	}
	return f.getKeyAliasByCertThumbprintFn(ctx, thumbprintHex)
}

func (f *fakeQuerier) GetKeyAliasByUniIdent(ctx context.Context, uniIdent string) (db.KeyAlias, error) {
	if f.getKeyAliasByUniIdentFn == nil {
		return db.KeyAlias{}, sql.ErrNoRows
	}
	return f.getKeyAliasByUniIdentFn(ctx, uniIdent)
}
