...
_Figure 2 – esignet-service component composition_
...
| `internal/engine`                            | MOSIP implementations of the ThunderID engine's provider interfaces (actor, authorization, consent bridge, flow, design, i18n, OU (stub), resource, attestation (stub), captcha, IDP, runtime crypto) |
...
_Figure 3 – oidc-ui component composition_
...
_Figure 4 – End-to-end login and consent sequence_
