	...
	public void test(TestCaseDTO testCaseDTO)
		...
		if (testCaseDTO.getTemplateFields() != null && templateFields.length > 0) {
			...
			if (testCaseName.contains("ESignet_")) {
				...
				} else if (testCaseName.contains("_PAR_DPoP_Header_Replay_")) {
					Response firstResponse = postWithBodyAndHeaderForAutoGeneratedIdForUrlEncoded(endPoint, jsonInput,
							testCaseDTO.getTestCaseName(), idKeyName);
					if (firstResponse == null || firstResponse.getStatusCode() >= 400) {
						throw new AdminTestException("Initial PAR request was not accepted, cannot validate DPoP replay rejection");
					}
					response = postWithBodyAndHeaderForAutoGeneratedIdForUrlEncoded(endPoint, jsonInput,
							testCaseDTO.getTestCaseName(), idKeyName);
				} else {
