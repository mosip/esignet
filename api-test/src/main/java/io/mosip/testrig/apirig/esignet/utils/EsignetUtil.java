...
//			BaseTestCase.setSupportedIdTypes(Arrays.asList("UIN", "VID"));
	...
	public void saveDpopNonce(Response response, String testCaseName) throws AdminTestException {
		logger.info("DPoP nonce received: " + response.getHeader("dpop-nonce").toString());
		autoGeneratedIDValueCache.put(testCaseName + "_dpopNonce", response.getHeader("dpop-nonce"));
	}
