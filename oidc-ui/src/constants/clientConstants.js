...
const crossBorderAuthConfigKeys = {
  walletName:"sign-in-plugin.oidc-config",
  signInButtonConfig: "sign-in-plugin.button-config",
};
...
const configurationKeys = {
  ...
  crossBorderAuthConfig: "cross-border-auth.config"
};
