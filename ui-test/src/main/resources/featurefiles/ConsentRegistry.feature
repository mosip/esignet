Feature: ES-3 Consent Registry
  ...
  self-skip when esignetDbHost, esignetDbName, or esignetDbPassword in config.properties isn't
  configured. TC_12 allows essential claims such as phone_number.
