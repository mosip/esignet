...
# Not in Go — mark NA (eKYC process steps screen does not exist in esignet-go/Thunder)
...
# Not in Go — mark NA (list of eKYC service providers screen does not exist in esignet-go/Thunder)
...
# Not in Go — mark NA (eKYC policy T&C screen does not exist in esignet-go/Thunder)
...
# Not in Go — mark NA (depends on eKYC process steps screen — not in esignet-go/Thunder)
