...
public class BaseTest extends AdminTestUtil{
	...
	public void enableMobileMode(Scenario scenario) {
	    ...
	    LOGGER.info("Mobile emulation enabled for scenario: " 
	        + scenario.getName() + " using device: " + mobileDevice);
	}
