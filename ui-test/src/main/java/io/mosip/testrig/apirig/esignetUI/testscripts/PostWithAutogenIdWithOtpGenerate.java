...
public class PostWithAutogenIdWithOtpGenerate extends EsignetUtil implements ITest {
	...
	public void test(TestCaseDTO testCaseDTO)
		...
		while (currLoopCount < maxLoopCount) {
			String input = inputstringKeyWordHandler(inputStrJson, testCaseName);
		...
		jsonInput = EsignetUtil.inputstringKeyWordHandler(jsonInput, testCaseName);
