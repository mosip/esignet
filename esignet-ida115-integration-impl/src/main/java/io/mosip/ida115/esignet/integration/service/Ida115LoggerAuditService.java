...
@ConditionalOnProperty(value = "mosip.esignet.integration.audit-plugin", havingValue = "Ida115LoggerAuditService")
@Component
@Slf4j
public class Ida115LoggerAuditService implements AuditPlugin {
