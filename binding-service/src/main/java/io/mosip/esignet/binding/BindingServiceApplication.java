 ...
 */
package io.mosip.esignet.binding;
...
@SpringBootApplication(scanBasePackages = { "io.mosip.esignet",
		"${mosip.esignet.authn.wrapper.scan.base-package}",
...
public class BindingServiceApplication
{
	public static void main(String[] args) {
		SpringApplication.run(BindingServiceApplication.class, args);
	}
}
