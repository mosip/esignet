...
public class ConsentHelperServiceTest {
    ...
    @Test
    public void getConsentAction_withValidConsentAndGetConsentActionAsNoCapture_thenPass() throws Exception {
        ...
        Assert.assertEquals(consentHelperService.getConsentAction(oidcTransaction,true),ConsentAction.NOCAPTURE);
    }

    @Test
    public void getConsentAction_withEmptyRequestedClaims_thenPass(){
        OIDCTransaction oidcTransaction=new OIDCTransaction();
        oidcTransaction.setClientId("abc");
        oidcTransaction.setPartnerSpecificUserToken("123");
        oidcTransaction.setVoluntaryClaims(List.of());
